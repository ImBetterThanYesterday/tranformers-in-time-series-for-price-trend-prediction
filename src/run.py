...
def run(config: Config, accelerator):
    """
    Ejecuta el entrenamiento del modelo sin WandB
    """
...
def run_wandb(config: Config, accelerator):
    """
    Ejecuta el entrenamiento con WandB logging
    """
...
def sweep_init(config: Config):
    """
    Inicializa la configuración para WandB sweeps (hyperparameter tuning)
    """
